...
class ScenarioExecutionStartingProcessor extends HookExecutionProcessor_1.HookExecutionProcessor {
    constructor() {
        super();
        this.hookType = HookType_1.HookType.BeforeScenario;
    }
    getExecutionInfo(message) {
        return message.scenarioExecutionStartingRequest
            .currentExecutionInfo;
    }
    getApplicableHooks(message) {
        const request = message.scenarioExecutionStartingRequest;
...
exports.ScenarioExecutionStartingProcessor = ScenarioExecutionStartingProcessor;
